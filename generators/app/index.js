        ...
        [
            {
                ...
                store: true,
                'default': this.config.get('moduleName') || this.appname.replace(/^.*? ([^ ]*)$/, '$1'),
            },
            {
                type: 'input',
                name: 'description',
                ...
                store: true,
                'default': this.config.get('description') || 'This is an AWS lambda function',
            },
            {
                type: 'input',
                name: 'githubOrg',
                ...
                store: true,
                'default': this.config.get('githubOrg') || 'hughescr',
            },
            {
                type: 'input',
                name: 'awsRegion',
